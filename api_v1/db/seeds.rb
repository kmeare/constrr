...
w1 = Work.create(name: 'Ciateq', description: 'CIATEQ, Centro de Tecnología Avanzada, ayudando a la industria mexicana en el desarrollo tecnológico', image: 'http://www.aguascalientes.gob.mx/temas/cienciainvestigacion/images/ciateq.jpg')